  ...
  \subsection{Sequence Diagrams}
    ...
    \subsubsection{Student uploads notes}
      \begin{figure}[H]
        ...
        \caption{Sequence diagram for a student uploading notes view the mobile client}
      \end{figure}
  ...
  \section{Participation journal}
    ...
    \subsection{Web}
      Justin Kim was responsible working on feed, search and login portion of the front-end. He also layed out the general structure of the front-end architecture. \\
      ...
      Both Justin and Ray made use of the React library to create these visual components and used Redux to implement the data layer in the web application. 
